...
VERSION=0.000130
URL=https://cpan.metacpan.org/authors/id/E/EX/EXODIST/Test2-Suite-0.000130.tar.gz
SECTION="Perl Module Dependencies"
DESCRIPTION="Test2::Suite is a distribution with a rich set of tools built upon the Test2 framework."
